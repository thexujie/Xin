...
class CNavigateToOriginalPathCommandVerb : public Xin::Win32::TUnknown<IExplorerCommand, IExplorerCommandState, IInitializeCommand, IObjectWithSite>
{
public:
	HRESULT QueryInterface(const IID & riid, void ** ppvObject) override
	{
		static const QITAB QueryInterfaceTable[] =
		{
			QITABENT(CNavigateToOriginalPathCommandVerb, IExplorerCommand), // required
			QITABENT(CNavigateToOriginalPathCommandVerb, IExplorerCommandState), // optional
		...
		return QISearch(this, QueryInterfaceTable, riid, ppvObject);
	}
	...
	IFACEMETHODIMP GetTitle(IShellItemArray * /* psiItemArray */, LPWSTR * ppszName) override
	{
		...
		return SHStrDupW(L"打开链接目标所在路径", ppszName);
	}
	...
	IFACEMETHODIMP GetState(IShellItemArray * ShellItemArray, BOOL fOkToBeSlow, EXPCMDSTATE * pCmdState) override;
	...
	~CNavigateToOriginalPathCommandVerb() override { }
private:
	Xin::TReferPtr<IUnknown> UnknownSite;
};
