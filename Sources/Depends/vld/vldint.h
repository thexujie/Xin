...
public:
    ...
    static NTSTATUS NTAPI _LdrGetDllHandle(IN PWSTR DllPath OPTIONAL, IN PULONG DllCharacteristics OPTIONAL, IN PWCHAR DllName, OUT PVOID *DllHandle OPTIONAL);
    static NTSTATUS NTAPI _LdrGetProcedureAddress(IN PVOID BaseAddress, IN PCHAR Name, IN ULONG Ordinal, OUT PVOID * ProcedureAddress);
